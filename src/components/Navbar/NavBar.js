      ...
      <Container style={{marginBottom:'50px '}} >
        ...
        <Nav.Link style={{ color: '#D19B6F' , marginLeft :'20px'}} href='/'>الرئيسيه</Nav.Link>
         ...
         <div  className=" nav-menu  ">
          ...
          <img src={nav4} alt='' style={{paddingLeft:'5px'}} />
          </Link>
         
          
          <Link to='/favScientists' >
          <img src={nav3} alt='' style={{paddingLeft:'5px'}}   />
          </Link>
          
          <Link to='/notification'>
          <img src={nav2} alt='' style={{paddingLeft:'5px'}} />
          </Link>
         
          
        <NavDropdown title={ <img src={nav1} alt='' /> } className='pp'    >
